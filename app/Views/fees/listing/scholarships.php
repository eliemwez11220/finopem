            ...
            <div class="card-body">
                <div class="row mb-2 text-center">
                    <div class="col-sm-12 col-lg-12">
                        <h1 class="font-weight-bold text-uppercase">configuration bourses des étudiants</h1>
                        <p class="font-weight-bold h5">
                            Veuillez sélectionner un étudiant bénéficiaire d'une bourse dans la liste ci-dessous
                        </p>
                    ...
                    <div class="col-sm-12 card">
                        ...
                        <div class="card-header">
                            <h3><i class="fas fa-list"></i>
                                BOURSES ACCORDEES A L'ETUDIANT
                            ...
                            <table class="table table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="">
                                            <input class="ml-5 chechbox" type="checkbox"
                                                value="<?= $exemption['exemption_id']; ?>"
                                                name="exemption_status<?= $exemption['exemption_id']; ?>" <?php  
