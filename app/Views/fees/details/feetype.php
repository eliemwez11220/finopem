                            ...
                            <div class="card-header bg-info text-center">
                                <h1 class="text-uppercase font-weight-bold">
                                        ...
                                        <span class="text-uppercase h3">
                                            Paiement <span class="text-danger"><?= setFeesTypes($feetype['fee_type']); ?>,</span>
                                             en 
                                            <span class="text-danger"><?= ($feetype['fee_currency_payable']); ?></span>
                                             <span class="text-danger"><?= ($feetype['fee_total_payable']); ?></span> fois 
                                        </span>
                                    ...
                                    if (isset($feesdetails) && !empty($feesdetails)):
                                        foreach ($feesdetails as $key => $value):
                                            ...
                                            <tr class="small">
                                                ...
                                                <td class="text-uppercase"><?= ($value['feedetail_name']); ?></td>
                                                <td class="text-uppercase"><?= ($value['feedetail_subname']); ?></td>
                                                <td class="text-uppercase text-center">
                                                    <?= number_format($value['feedetail_cost_payable'], 2, ',', ' '); ?> 
                                                    <?= ($feetype['fee_currency_payable']); ?> 
                                                                ...
                                                                <div class="col-lg-12 col-sm-12 col-xs-12 mb-3">
                                                                    ...
                                                                    <div class="form-floating">
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            <span class="text-danger">*</span>Montant payable (en <?= setCurrency($feetype['fee_currency_payable']); ?>)
                                                                        </label>
                                                                    </div>
                                                                ...
                                                                <div class="col-lg-12 col-sm-12 col-xs-12 mb-2">
                                                                    <div class="form-floating">
                                                                        ...
                                                                        <label for="shortname" class="control-label">
                                                                            <span class="text-danger"></span>Abbréviation  frais
                                                                        </label>
