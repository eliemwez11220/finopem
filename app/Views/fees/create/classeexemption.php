                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item">
                                <a href="<?= base_url('fees/exemptions') ?>">
                                    Exhonérations</a>
                            </li>
                            <li class="breadcrumb-item active">Exhonération par promotions</li>
                        </ol>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row mb-2 text-center">
                        <div class="col-sm-12 col-lg-12">
                            ...
                            <h2 class="text-uppercase text-danger font-weight-bold">
                                Bourse <?= trim($exemption['exemption_name']); ?> | réduction de
                                <?= number_format($exemption['exemption_cost_discount'], 2,',', ' '); ?>
                                <?= trim($exemption['exemption_currency']); ?>
                            </h2>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input class="chechbox" type="checkbox" value="<?= $key['classe_id']; ?>"
                                                name="etatClasse<?= $key['classe_id']; ?>" <?php if (isset($classesexemptions) && !empty($classesexemptions)){ 
