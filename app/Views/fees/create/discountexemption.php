                                      ...
                                      <tbody>
                                          ...
                                          <tr>
                                              <td class="text-uppercase font-weight-bold">
                                                  <?= $key['fee_name'];?>
                                                  <span class="text-danger font-weight-bold">[<?= $key['feedetail_name'];?>]</span>
                                              </td>
                                              ...
                                              <td>
                                                ...
                                                <span class="text-primary font-weight-bold text-uppercase small">
                                                  ...
                                                  <input class="chechbox" type="checkbox" value="<?= $key['feedetail_id']; ?>"
                                                      name="etatClasse<?= $key['feedetail_id']; ?>" 
                                                      <?php if (isset($discountsexemptions) && !empty($discountsexemptions)){ 
                            ...
                            <?php }?>
                                  <div class="form-group float-right">
                                      <button type="submit" name="btn_save" class="btn btn-info">
                                          <i class="fa fa-check-circle"></i> Valider la configuration des frais de la bourse</button>
                                  </div>
                             <?= form_close(); ?>
                          </div>
                      </div>
