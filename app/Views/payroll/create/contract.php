                ...
                ?>
                    <div class="row">
                            ...
                            <div class="form-floating">
                                <select
                                    ...
                                    <option value="<?= $worker['agent_uid'] ?>"
                                        <?= set_select('worker', esc($worker['agent_uid'])); ?>>
                        ...
                        <div class="col-lg-6 col-sm-12 col-xs-12 mb-2">
                            <div class="form-floating">
                                <select
                                    class="form-control form-select <?php if ($validation->hasError('type')) {echo 'is-invalid'; } ?>"
                        ...
                        <div class="col-lg-6 col-sm-12 col-xs-12">
                            <div class="form-floating">
                                <select
                                    class="form-select form-control <?php if ($validation->hasError('category')) {echo 'is-invalid'; } ?>"
                                    id="category" name="category" required>
                                    <option selected disabled>--Choisissez une catégorie</option>
                                    <?php if (isset($categories) && !empty($categories)): ?>
                                    <?php foreach ($categories as $category): ?>
                                    <option value="<?= $category['category_uid'] ?>"
                                        <?= set_select('category', esc($category['category_uid'])); ?>>
                        ...
                        <div class="col-lg-6 col-sm-12 col-xs-12 mb-2">
                            <div class="form-floating">
                                <input type="date"
                                    ...
                                    id="start_date" name="start_date" value="<?= set_value('start_date') ?>">
                        ...
                        <div class=" col-sm-12 col-lg-6">
                            <div class="form-floating mb-2">
                                <input type="number" step="0.01" class="form-control" id="daily_salary"
                                    name="daily_salary" value="<?= set_value('daily_salary'); ?>"
                                    placeholder="Ex: 5000">
                        ...
                        <div class="col-lg-6 col-sm-12 col-xs-12 mb-2">
                            <div class="form-floating">
                                <input type="number" class="form-control" id="salary" name="salary" step="0.01"
                                    placeholder="EX:100000" value="<?= set_value('salary') ?>">
