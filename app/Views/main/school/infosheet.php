                ...
                <div class="card-footer">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-lg-6">
                            <h3 class="font-weight-bold">Fiche de l'établissement</h3>
                        </div>
                        <div class="col-sm-6">
                            <div class="card-tools float-right">
                                <?php if (isset($school) && (!empty($school))): ?>
                                <a class="btn btn-info btnrounded"
                                    href="<?= base_url('school/update/'.$school['school_id']); ?>">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    <h5 class="text-muted small">
                                        <span>Responsable de l'établissement</span>
                                    </h5>
                    ...
                    <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
                        <div class="app-card-body p-3 px-4 w-100">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    <h5 class="text-muted small">
                                        <span>Code d'identification de l'établissement</span>
                                    </h5>
                                    <h3 class="app-card-title text-uppercase fw-bold">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    <h5 class="text-muted small">
                                        <span>Etat de l'établissement</span>
                                    </h5>
                                    <h3 class="app-card-title text-uppercase fw-bold">
            ...
            <div class="modal-header text-center">
                <h4 class="modal-title d-inline-flex">
                    <span id="offcanvasEditLabel" class="h5 text-uppercase">
                        Changement du logo de l'établissement
                    </span>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 form-group">
                        <label for="logo" class="label-control">
                            <span class="text-danger">*</span>Charger le logo de l'établissement</label>
                    ...
                    <div class="col-md-12 form-group">
                        <label for="picture" class="label-control"><span class="text-danger"></span>
                            Photo de couverture de l'établissement</label>
