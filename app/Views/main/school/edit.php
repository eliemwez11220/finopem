...
<div class="content-wrapper <?= checkModuleAccess('infosheet'); ?>">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                            ...
                            <div class="card-tools float-right">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">
                                        <a href="<?= base_url('dashboard') ?>" class="">Accueil</a>
                                    </li>
                                    <li class="breadcrumb-item active">Vue d'ensemble</li>
                                    <li class="breadcrumb-item active">Fiche établissement</li>
                                </ol>
                            </div>
                        </div>
                        ...
                        echo form_open(base_url('school/update/'.$school['school_id']), $attributes);
                        ?>
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-12 col-xs-12 mb-2">
                                    <div class="form-floating">
                                        <input type="text" class="form-control <?php if ($validation->hasError('init_identify')) {
                                                   echo 'is-invalid';
                                               } ?>" name="init_identify" id="init_identify" minlength="1" maxlength="3"
                                            placeholder="Ex: CSD"
                                ...
                                <div class="col-lg-6 col-sm-12 col-xs-12 mb-2">
                                    <div class="form-floating">
                                        <input type="text" class="form-control <?php if ($validation->hasError('school_phone')) {
                                            ...
                                            placeholder="Ex:+243858533285" value="<?= ($school['school_phone']) ? $school['school_phone']:set_value('school_phone') ?>" />
                                ...
                                <div class="col-lg-6 col-sm-12 col-xs-12 mb-2">
                                    <div class="form-floating">
                                        <input type="email" class="form-control " name="school_email" id="school_email"
                                            placeholder="Ex:+243858533285" value="<?= ($school['school_email']) ? $school['school_email']:set_value('school_email') ?>" />
