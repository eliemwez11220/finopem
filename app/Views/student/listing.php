                ...
                <div class="col-sm-12 col-lg-12">
                    <nav aria-label="breadcrumb" class="">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Registre des élèves</li>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-4 col-lg-4">
                    <div class="float-right">
                        <a href="<?= base_url('student/registration'); ?>" class="btn btn-info btn-lg text-uppercase"
                    ...
                    <div class="card">
                        <div class="card-header bg-info text-center">
                            <h1 class="text-uppercase font-weight-bold">
                                Liste des élèves inscrits en <?= session()->schoolyear; ?></h1>
