                ...
                <div class="col-sm-6">
                    <div class="card-tools printoff">
                        ...
                        <a data-toggle="modal" data-target="#nouvelle_annee" href="#"
                            ...
                            <span data-toggle="tooltip" data-placement="top" title="Cliquer pour créer un parcours">
                            ...
                            <div class="card-header bg-info text-center">
                                <h1 class="text-uppercase font-weight-bold">
                                    ...
                                    <span class="text-uppercase h3">
                                        Né à <?= esc($student['student_born_place']); ?>,
                                        le <?= date("d/m/Y", strtotime($student['student_birthday'])); ?>
                                    </span>
                                ...
                                <table class="table table-sm table-striped table-hover" id="datatablesReportingActions">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="small text-center">
                                            ...
                                            <td class="text-uppercase"><?= ucfirst(($value['option_name'])); ?> </td>
                                            <td class="text-uppercase"><?= $value['section_name']; ?></td>
                                            <td class="text-uppercase">
                                            ...
                                            <td class="text-uppercase"><?= $value['inscription_origin_school']; ?></td>
