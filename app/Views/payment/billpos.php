                            ...
                            <table class="table table-striped table-bordered">
                                            ...
                                            <ul class="text-left">
                                                <li class="small text-uppercase font-weight-bold">
                                                    <b>
                                                        ...
                                                        <span class="text-primary"> <?= $payment['feedetail_name']; ?> [ <?= number_format($payable_amount, 0, ',', ' ') .' '.$currency_paid; ?> ]</span>
                                                        <br> Payé: <?= number_format($pay_amount, 0, ',', ' ') .' '.$currency_paid; ?> {Reste = <?= number_format($fee_balance, 2, ',', ' ').' '.$currency_paid; ?> }
                                                    </b>
                                ...
                                <?php } ?>
                                    <p class="font-weight-bold text-uppercase mt-2 text-center">
                                        <b style="border-bottom: 2px solid black;border-top: 2px solid black;"> == Récapitulatif du versément ==</b>
                                    </p>
