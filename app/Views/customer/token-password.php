    ...
    <div class="container-fluid page-body-wrapper full-page-wrapper">
        <div class="content-wrapper auth auth-img-bg">
            <div class="row h-100 w-100">
                <div class="col-lg-6 col-sm-12 offset-lg-3 bg-info  text-white">
                    <div class="text-center py-3">
                        <a href="<?= base_url(); ?>" class="h1 font-weight-bold text-uppercase text-white">
                            Magschool
                        </a>
                    </div>
<div class="auth-form-transparent card-radius card shadow-lg">
    ...
    <?php
                        ...
                        echo form_open(base_url('confirmPasswordRequest'), $attributes);
                        ?>
    <div class="py-3">
        ...
        <div class="row my-3 d-flex">
            <div class="col-lg-4 col-sm-12 float-left">
                <a href="<?= base_url('forgetPassword'); ?>" class="btn btn-danger  btn-lg py-3 fw-bold">
