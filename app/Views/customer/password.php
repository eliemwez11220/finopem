                    ...
                    <div class="app-card-header p-3 border-bottom-0 mt-5">
                        ...
                        <div class="row align-items-center gx-3 mt-5">
                            ...
                            <div class="col-auto">
                                ...
                                href="<?= base_url('customer-profile'); ?>">
                                    <i class="fas fa-chevron-left"></i> Retour au profile</a>
                            </div>
                            <div class="col-auto">
                                <h3 class="app-card-title text-uppercase font-weight-bold">
                                    <?= session()->get('customername'); ?></h3>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php
                                ...
                                echo form_open(base_url('admincustomer/password'), $attributes);
                                ?>
                            <div class="card-body">
                            <input type="text" name="customername-fake" id="customername-fake" style="display:none;">
