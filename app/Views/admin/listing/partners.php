<div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container">
        ...
        <div class="row g-3 mb-4 align-items-center justify-content-between">
            <div class="col-auto">
                <h1 class="app-page-title mb-0">Gestion des Partenaires</h1>
            </div>
            <div class="col-auto">
                <div class="page-utilities">
                    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                        <div class="col-auto">
                            <a class="btn btn-primary btnrounded" href="<?= base_url('admin/create/partner'); ?>" >
                                <i class="fas fa-plus"></i> Nouveau Partenaire</a>
                        </div>
                    </div><!--//row-->
                </div><!--//table-utilities-->
            </div><!--//col-auto-->
                                    ...
                                    foreach ($customers as $key => $value):
                                        ...
                                        <tr class="small <?= ($status == 'actif') ? '' : 'alert alert-warning'; ?>">
                                            ...
                                            <td class="text-end">
                                                    ...
                                                    <a href="<?= base_url('admin/edit/partner/' . $customer_uid); ?>"
                                                    class="btn btn-primary btn-sm" data-bs-toggle="tooltip"
                                                                data-bs-placement="top"
                                                                title="Modification des infos">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <a href="<?= base_url('admin/details/partner/' . $customer_uid); ?>"
                                        ...
                                        <div class="offcanvas offcanvas-end  bg-gray-200"
                                            ...
                                            <div class="offcanvas-header text-center">
                                                <h4 class="offcanvas-title d-inline-flex">
                                                    Mise à jour du statut du Partenaire <?= $value['client_name']; ?>
                                                </h4>
