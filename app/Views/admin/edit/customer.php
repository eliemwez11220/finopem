    ...
    <div class="app-content pt-3 p-md-3 p-lg-4 <?= checkModuleAccess(null, 'admins'); ?>">
        <div class="container">
                        ...
                        <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                            <div class="col-auto">
                                ...
                                <a class="btn btn-success btn-sm"
                                   href="<?= base_url('admin/details/customer/'.$customer['client_uid']); ?>">
            ...
            <div class="text-center">
                <h1 class="app-title">Modification fiche d'un client</h1>
            </div></div>
                    ...
                    <div class="col-12">
                        <div class="card bg-gray-200">
                            <div class="card-content">
                                ...
                                ?>
                                <input type="hidden" value="customer" name="category">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6 form-group">
                                            <select class="choices form-select text-capitalize <?= ($validation->hasError('type_user')) ? ' is-invalid' : '' ?>"
                                                ...
                                                <?php
                                                $old_type_db = $customer['client_category'];
