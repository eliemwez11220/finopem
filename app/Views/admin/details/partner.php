    ...
    <div class="app-content pt-3 p-md-3 p-lg-4 <?= checkModuleAccess(null, 'admins'); ?>">
        <div class="container">
                        ...
                        <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                            <div class="col-auto">
                                ...
                                <a class="btn btn-primary btn-sm"
                                   href="<?= base_url('admin/edit/partner/'.$customer['client_uid']); ?>">
                                    <i class="fas fa-edit"></i> Editer
                                </a>
                                <a class="btn btn-success btn-sm"
                                    onclick="return confirm('Etes-vous sûr de vouloir publier ce Partenaire sur votre site internet ?'); false;"
                                   href="<?= base_url('admin/publish/partner/'.$customer['client_nature'].'/'.$customer['client_uid']); ?>">
            ...
            <div class="text-center">
                <h1>Fiche d'informations sur un Partenaire</h1>
            </div></div>
                        ...
                        <div class="app-card-body px-4 w-100">
                            ...
                            <div class="item border-bottom py-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <span class="fw-bold text-capitalize">
                                            <?= ($customer['client_category'] == 'customer')? 'Client': 'Partenaire'; ?>
                                        </span>
                                    </div><!--//col-->
                                </div><!--//row-->
                            </div><!--//item-->
                            <div class="item border-bottom py-3 bg-info">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <div class="item-data"><strong>Nature du client</strong></div>
                                        <span class="fw-bold text-capitalize">
                                            <?= ($customer['client_nature'] == 'private')? 'privée': 'public'; ?>
                                        </span>
                                    </div><!--//col-->
                                </div><!--//row-->
                            </div><!--//item-->
                    ...
                    <div class="app-card app-card-account shadow-lg d-flex flex-column align-items-start">
                        <div class="app-card-body px-4 w-100">
                            ...
                            <div class="item border-bottom py-3">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <div class="item-label mb-2"><i class="fas fa-map"></i></div>
                            ...
                            <div class="item border-bottom py-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <div class="item-data"><strong>Observation client</strong></div>
                                        <span class="fw-bold text-capitalize">
